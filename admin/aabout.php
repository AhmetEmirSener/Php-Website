...
if(isset($usertype)){
    $query = mysqli_query($conn, "SELECT * FROM aboutpage") or die('query executed');
...
if(isset($_POST['update'])){
    ...
    mysqli_query($conn, "UPDATE `aboutpage` SET text = '$update_text' , img = '$file_name' WHERE id = '$update_id'") or die('query failed');
...
<nav class="navbar">
    ...
    <div class="form-container">
        ...
        <h3>Hakkımızda</h3>
            ...
            <textarea name="textarea" id="txt" rows="25" cols="100 "><?php echo $text ?></textarea>    
